...
//    private String userExistMessage;
    ...
    public void saveUserList(User user) throws UserExistException, UserExistExceptionWithMailId {
//      try{
...
//      }
    ...
    public Optional<User> searchById(String loginId) throws UserNotFoundException {
        Optional<User> user= Optional.ofNullable(repository.findByLoginId(loginId));
        if(user.isPresent())
         return user;
       else
